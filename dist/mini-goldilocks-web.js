...
* @returns {any[]}
*/
export function poseidon_u64_wrapper(inputs) {
    try {
...
* @returns {any[]}
*/
export function poseidon_u64_bytes_wrapper(inputs) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
...
* @returns {any}
*/
export function poseidon_u64_for_bytes_wrapper(inputs) {
    const ptr0 = passArray64ToWasm0(inputs, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
...
* @returns {any}
*/
export function poseidon_u64_bytes_for_bytes_wrapper(inputs) {
    const ptr0 = passArray8ToWasm0(inputs, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
...
async function __wbg_init(input) {
    ...
    if (typeof input === 'undefined') {
        input = new URL('mini-goldilocks-web_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
